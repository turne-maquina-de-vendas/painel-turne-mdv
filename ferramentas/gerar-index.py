...
import re as _re
_esperados = ["REMESSAS_MDV", "REMESSAS_RGV", "REMESSAS_MQV", "REMESSAS_MET", "FUNIS_MDV", "FUNIS_RGV", "FUNIS_MQV", "FUNIS_MET", "VIDEOS_MDV", "VIDEOS_RGV", "VIDEOS_MQV", "VIDEOS_MET", "PRODUTOS"]
