...
import re as _re
_esperados = ["REMESSAS_MDV", "REMESSAS_RGV", "REMESSAS_MQV", "REMESSAS_MET", "REMESSAS_B10X", "REMESSAS_INSTA", "FUNIS_MDV", "FUNIS_RGV", "FUNIS_MQV", "FUNIS_MET", "FUNIS_B10X", "FUNIS_INSTA", "VIDEOS_MDV", "VIDEOS_RGV", "VIDEOS_MQV", "VIDEOS_MET", "VIDEOS_B10X", "PRODUTOS"]
